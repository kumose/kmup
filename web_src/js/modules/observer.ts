...
function callGlobalInitFunc(el: HTMLElement) {
  ...
  type KmupGlobalInitElement = Partial<HTMLElement> & {_kmupGlobalInited: boolean};
  if ((el as KmupGlobalInitElement)._kmupGlobalInited) return;
  (el as KmupGlobalInitElement)._kmupGlobalInited = true;
