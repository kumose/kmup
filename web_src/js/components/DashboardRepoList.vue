...
const commitStatus: CommitStatusMap = {
  ...
  error: {name: 'kmup-exclamation', color: 'red'},
  failure: {name: 'octicon-x', color: 'red'},
  warning: {name: 'kmup-exclamation', color: 'yellow'},
      ...
      <div v-if="repos.length" class="ui attached table segment tw-rounded-b">
        ...
        <div v-if="showMoreReposLink" class="tw-text-center">
          ...
          <div class="ui borderless pagination menu narrow tw-my-2">
            ...
            >
              <svg-icon name="kmup-double-chevron-left" :size="16" class="tw-mr-1"/>
            </a>
            <a
              class="item navigation tw-py-1" :class="{'disabled': page === 1}"
            ...
            >
              <svg-icon name="kmup-double-chevron-right" :size="16" class="tw-ml-1"/>
            </a>
          </div>
        </div>
      </div>
