...
type ComboMarkdownEditorTextarea = HTMLTextAreaElement & {_kmupComboMarkdownEditor: any};
type ComboMarkdownEditorContainer = HTMLElement & {_kmupComboMarkdownEditor?: any};
...
export class ComboMarkdownEditor {
  ...
  constructor(container: ComboMarkdownEditorContainer, options:ComboMarkdownEditorOptions = {}) {
    if (container._kmupComboMarkdownEditor) throw new Error('ComboMarkdownEditor already initialized');
    container._kmupComboMarkdownEditor = this;
  ...
  setupTextarea() {
    ...
    this.textarea._kmupComboMarkdownEditor = this;
  ...
  prepareEasyMDEToolbarActions() {
    this.easyMDEToolbarDefault = [
      ...
      'heading-bigger', 'heading-smaller', '|', 'code', 'quote', '|', 'kmup-checkbox-empty',
      'kmup-checkbox-checked', '|', 'unordered-list', 'ordered-list', '|', 'link', 'image',
      'table', 'horizontal-rule', '|', 'kmup-switch-to-textarea',
    ];
  }
...
export function getComboMarkdownEditor(el: any) {
  ...
  return el._kmupComboMarkdownEditor;
}
