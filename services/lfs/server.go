...
import (
	...
	"github.com/kumose/kmup/modules/auth/httpauth"
	"github.com/kumose/kmup/modules/json"
	lfs_module "github.com/kumose/kmup/modules/lfs"
...
func DownloadHandler(ctx *context.Context) {
	...
	ctx.Resp.Header().Set("X-Kmup-LFS-Content-Length", contentLengthStr) // we need this header to make sure it won't be affected by reverse proxy or compression
...
func requireAuth(ctx *context.Context) {
	ctx.Resp.Header().Set("WWW-Authenticate", `Basic realm="kmup-lfs"`)
