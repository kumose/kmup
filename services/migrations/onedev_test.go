...
func TestOneDevDownloadRepo(t *testing.T) {
	resp, err := http.Get("https://code.onedev.io/projects/go-kmup-test_repo")
	...
	ctx := t.Context()
	downloader := NewOneDevDownloader(ctx, u, "", "", "go-kmup-test_repo")
	if err != nil {
	...
	assertRepositoryEqual(t, &base.Repository{
		Name:        "go-kmup-test_repo",
		Owner:       "",
		Description: "Test repository for testing migration from OneDev to kmup",
		CloneURL:    "https://code.onedev.io/go-kmup-test_repo",
		OriginalURL: "https://code.onedev.io/projects/go-kmup-test_repo",
	}, repo)
