...
func TestGitHubDownloadRepo(t *testing.T) {
	...
	ctx := t.Context()
	downloader := NewGithubDownloaderV3(ctx, "https://github.com", "", "", token, "go-kmup", "test_repo")
	...
	assertRepositoryEqual(t, &base.Repository{
		Name:          "test_repo",
		Owner:         "go-kmup",
		Description:   "Test repository for testing migration from github to kmup",
		CloneURL:      "https://github.com/go-kmup/test_repo.git",
		OriginalURL:   "https://github.com/go-kmup/test_repo",
		DefaultBranch: "master",
	}, repo)

	topics, err := downloader.GetTopics(ctx)
	assert.NoError(t, err)
	assert.Contains(t, topics, "kmup")
	...
	assertPullRequestsEqual(t, []*base.PullRequest{
		{
			...
			PatchURL: "https://github.com/go-kmup/test_repo/pull/3.patch",
		...
		},
		{
			...
			PatchURL: "https://github.com/go-kmup/test_repo/pull/4.patch",
			Head: base.PullRequestBranch{
				Ref:       "test-branch",
