...
import (
	...
	"github.com/kumose/kmup/modules/uri"
...
var _ base.Uploader = &KmupLocalUploader{}

// KmupLocalUploader implements an Uploader to kmup sites
type KmupLocalUploader struct {
...
// NewKmupLocalUploader creates an kmup Uploader via kmup API v1
func NewKmupLocalUploader(_ context.Context, doer *user_model.User, repoOwner, repoName string) *KmupLocalUploader {
	return &KmupLocalUploader{
		doer:        doer,
		repoOwner:   repoOwner,
		repoName:    repoName,
...
func (g *KmupLocalUploader) MaxBatchInsertSize(tp string) int {
	switch tp {
	case "issue":
...
func (g *KmupLocalUploader) CreateRepo(ctx context.Context, repo *base.Repository, opts base.MigrateOptions) error {
...
func (g *KmupLocalUploader) Close() {
	if g.gitRepo != nil {
		g.gitRepo.Close()
	}
}
...
func (g *KmupLocalUploader) CreateTopics(ctx context.Context, topics ...string) error {
...
func (g *KmupLocalUploader) CreateMilestones(ctx context.Context, milestones ...*base.Milestone) error {
...
func (g *KmupLocalUploader) CreateLabels(ctx context.Context, labels ...*base.Label) error {
...
func (g *KmupLocalUploader) CreateReleases(ctx context.Context, releases ...*base.Release) error {
...
func (g *KmupLocalUploader) SyncTags(ctx context.Context) error {
	return repo_module.SyncReleasesWithTags(ctx, g.repo, g.gitRepo)
}

// CreateIssues creates issues
func (g *KmupLocalUploader) CreateIssues(ctx context.Context, issues ...*base.Issue) error {
...
func (g *KmupLocalUploader) CreateComments(ctx context.Context, comments ...*base.Comment) error {
...
func (g *KmupLocalUploader) CreatePullRequests(ctx context.Context, prs ...*base.PullRequest) error {
...
func (g *KmupLocalUploader) updateGitForPullRequest(ctx context.Context, pr *base.PullRequest) (head string, err error) {
...
func (g *KmupLocalUploader) newPullRequest(ctx context.Context, pr *base.PullRequest) (*issues_model.PullRequest, error) {
	var labels []*issues_model.Label
...
func (g *KmupLocalUploader) CreateReviews(ctx context.Context, reviews ...*base.Review) error {
...
func (g *KmupLocalUploader) Rollback() error {
...
func (g *KmupLocalUploader) Finish(ctx context.Context) error {
	if g.repo == nil || g.repo.ID <= 0 {
...
func (g *KmupLocalUploader) remapUser(ctx context.Context, source user_model.ExternalUserMigrated, target user_model.ExternalUserRemappable) error {
	var userID int64
	var err error
	if g.sameApp {
...
func (g *KmupLocalUploader) remapLocalUser(ctx context.Context, source user_model.ExternalUserMigrated) (int64, error) {
...
func (g *KmupLocalUploader) remapExternalUser(ctx context.Context, source user_model.ExternalUserMigrated) (userid int64, err error) {
	userid, ok := g.userMap[source.GetExternalID()]
	if !ok {
