...
func TestFeishuPayload(t *testing.T) {
	...
	t.Run("Package", func(t *testing.T) {
		...
		assert.Equal(t, "Package created: KmupContainer:latest by user1", pl.Content.Text)
	})
...
func TestFeishuJSONPayload(t *testing.T) {
	...
	assert.Equal(t, "[test/repo:test] \r\n[2020558](http://localhost:3326/test/repo/commit/2020558fe2e34debb818a514715839cabd25e778) commit message - user1\r\n[2020558](http://localhost:3326/test/repo/commit/2020558fe2e34debb818a514715839cabd25e778) commit message - user1", body.Content.Text)
