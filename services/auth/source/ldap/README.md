# Kmup LDAP Authentication Module
...
* Group Name Filter (optional)
  ...
  * Example: (|(cn=kmup_users)(cn=admins))
...
* Team group map (optional)
  ...
  * Example: {"cn=MyGroup,cn=groups,dc=example,dc=org": {"MyKmupOrganization": ["MyKmupTeam1", "MyKmupTeam2", ...], ...}, ...}
