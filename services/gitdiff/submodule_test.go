...
+++ b/.gitmodules
@@ -0,0 +1,3 @@
+[submodule "kmup-mirror"]
+	path = kmup-mirror
+	url = https://kmup.com/kmup/kmup-mirror
diff --git a/kmup-mirror b/kmup-mirror
...
`,
		...
		{
			name: "updated",
			gitdiff: `diff --git a/kmup-mirror b/kmup-mirror
...
+	path = kmup
 	url = https://kmup.com/kmup/kmup-mirror
diff --git a/kmup-mirror b/kmup
similarity index 100%
rename from kmup-mirror
rename to kmup
`,
		},
		{
...
@@ -1 +0,0 @@
-Subproject commit c8ffe777cf9c5bb47a38e3e0b3a3b5de6cd8813d
diff --git a/kmup-1.22 b/kmup-1.22
new file mode 160000
