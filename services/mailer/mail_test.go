...
import (
	...
	"github.com/kumose/kmup/services/attachment"
...
func prepareMailerTest(t *testing.T) (doer *user_model.User, repo *repo_model.Repository, issue *issues_model.Issue, comment *issues_model.Comment) {
	...
	setting.MailService = &setting.Mailer{From: "test@kmup.com"}
...
func TestComposeIssueComment(t *testing.T) {
	...
	recipients := []*user_model.User{{Name: "Test", Email: "test@kmup.com"}, {Name: "Test2", Email: "test2@kmup.com"}}
...
func TestTemplateSelection(t *testing.T) {
	...
	recipients := []*user_model.User{{Name: "Test", Email: "test@kmup.com"}}
...
func TestGenerateAdditionalHeadersForIssue(t *testing.T) {
	...
	recipient := &user_model.User{Name: "test", Email: "test@kmup.com"}

	headers := generateAdditionalHeadersForIssue(comment, "dummy-reason", recipient)

	expected := map[string]string{
		"List-ID":                   "user2/repo1 <repo1.user2.localhost>",
		"List-Archive":              "<https://try.kmup.io/user2/repo1>",
		"X-Kmup-Reason":            "dummy-reason",
		"X-Kmup-Sender":            "user2",
		"X-Kmup-Recipient":         "test",
		"X-Kmup-Recipient-Address": "test@kmup.com",
		"X-Kmup-Repository":        "repo1",
		"X-Kmup-Repository-Path":   "user2/repo1",
		"X-Kmup-Repository-Link":   "https://try.kmup.io/user2/repo1",
		"X-Kmup-Issue-ID":          "1",
		"X-Kmup-Issue-Link":        "https://try.kmup.io/user2/repo1/issues/1",
	}
