...
func TestRenameUser(t *testing.T) {
	...
	t.Run("Non usable username", func(t *testing.T) {
		usernames := []string{"--diff", ".well-known", "kmup-actions", "aaa.atom", "aa.png"}
...
func TestCreateUser_Issue5882(t *testing.T) {
	...
	tt := []struct {
		...
		{&user_model.User{Name: "KmupBot", Email: "KmupBot@kmup.io", Passwd: passwd, MustChangePassword: false}, false},
		{&user_model.User{Name: "KmupBot2", Email: "KmupBot2@kmup.io", Passwd: passwd, MustChangePassword: false}, true},
	}
