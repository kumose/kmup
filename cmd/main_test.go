...
func TestCliCmd(t *testing.T) {
	...
	cases := []struct {
		...
		{
			cmd: "./kmup -c /dev/null -h",
			exp: "ConfigFile: /dev/null",
		},

		{
			cmd: "./kmup -c /dev/null help",
			exp: "ConfigFile: /dev/null",
		},
		{
			cmd: "./kmup help -c /dev/null",
			exp: "ConfigFile: /dev/null",
		},

		{
			cmd: "./kmup -c /dev/null test-cmd -h",
			exp: "ConfigFile: /dev/null",
		},
		{
			cmd: "./kmup test-cmd -c /dev/null -h",
			exp: "ConfigFile: /dev/null",
		},
		{
			cmd: "./kmup test-cmd -h -c /dev/null",
			exp: "ConfigFile: /dev/null",
		},

		{
			cmd: "./kmup -c /dev/null test-cmd help",
			exp: "ConfigFile: /dev/null",
		},
		{
			cmd: "./kmup test-cmd -c /dev/null help",
			exp: "ConfigFile: /dev/null",
		},
		{
			cmd: "./kmup test-cmd help -c /dev/null",
			exp: "ConfigFile: /dev/null",
		},
...
func TestCliCmdError(t *testing.T) {
	...
	r, err := runTestApp(app, "./kmup", "test-cmd")
	assert.Error(t, err)
	...
	r, err = runTestApp(app, "./kmup", "test-cmd", "--no-such")
	assert.Error(t, err)
	assert.Equal(t, 1, r.ExitCode)
	assert.Empty(t, r.Stdout)
...
func TestCliCmdBefore(t *testing.T) {
	...
	_, err := runTestApp(app, "./kmup", "--config", "/dev/null", "test-cmd")
	assert.NoError(t, err)
