...
import (
	...
	nuget_module "github.com/kumose/kmup/modules/packages/nuget"
	"github.com/kumose/kmup/modules/setting"
	"github.com/kumose/kmup/modules/structs"
	"github.com/kumose/kmup/routers/api/packages/nuget"
	packageService "github.com/kumose/kmup/services/packages"
...
func TestPackageNuGet(t *testing.T) {
	...
	packageIconURL := "https://kmup.io/favicon.png"
	packageLanguage := "Package Language"
	packageLicenseURL := "https://kmup.io/license"
...
AAAjQmxvYgAAAGm7ENm9SGxMtAFVvPUsPJTF6PbtAAAAAFcVogEJAAAAAQAAAA==`)
	...
	t.Run("Download", func(t *testing.T) {
		...
		t.Run("Symbol", func(t *testing.T) {
			...
			req := NewRequest(t, "GET", fmt.Sprintf("%s/symbols/%s/%sFFFFFFFF/kmup.pdb", url, symbolFilename, symbolID))
			MakeRequest(t, req, http.StatusBadRequest)
