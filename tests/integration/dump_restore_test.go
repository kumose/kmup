...
func TestDumpRestore(t *testing.T) {
	onKmupRun(t, func(t *testing.T, u *url.URL) {
		...
		//
		// Phase 1: dump repo1 from the Kmup instance to the filesystem
		//
		...
		//
		// Phase 2: restore from the filesystem to the Kmup instance in restoredrepo
		//
		...
		//
		// Phase 3: dump restored from the Kmup instance to the filesystem
		//
