...
func TestAPIRepoMigrate(t *testing.T) {
	testCases := []struct {
		...
		{ctxUserID: 1, userID: 2, cloneURL: "https://github.com/go-kmup/test_repo.git", repoName: "git-admin", expectedStatus: http.StatusCreated},
		{ctxUserID: 2, userID: 2, cloneURL: "https://github.com/go-kmup/test_repo.git", repoName: "git-own", expectedStatus: http.StatusCreated},
...
func TestAPIRepoMigrateConflict(t *testing.T) {
	onKmupRun(t, testAPIRepoMigrateConflict)
}
...
func TestAPIRepoCreateConflict(t *testing.T) {
	onKmupRun(t, testAPIRepoCreateConflict)
}
