...
func TestRepoCommits(t *testing.T) {
	...
	t.Run("CommitListNonExistingCommiter", func(t *testing.T) {
		// check the commit list for a repository with no kmup user
...
func TestRepoCommitsWithStatusError(t *testing.T) {
	doTestRepoCommitWithStatus(t, "error", "kmup-exclamation", "red")
}
...
func TestRepoCommitsWithStatusWarning(t *testing.T) {
	doTestRepoCommitWithStatus(t, "warning", "kmup-exclamation", "yellow")
}
