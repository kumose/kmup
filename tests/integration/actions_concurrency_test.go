...
func TestWorkflowConcurrency(t *testing.T) {
	onKmupRun(t, func(t *testing.T, u *url.URL) {
		...
		wf1TreePath := ".kmup/workflows/concurrent-workflow-1.yml"
		wf1FileContent := `name: concurrent-workflow-1
on: 
  push:
    paths:
      - '.kmup/workflows/concurrent-workflow-1.yml'
concurrency:
...
`
		wf2TreePath := ".kmup/workflows/concurrent-workflow-2.yml"
		wf2FileContent := `name: concurrent-workflow-2
on: 
  push:
    paths:
      - '.kmup/workflows/concurrent-workflow-2.yml'
concurrency:
  group: workflow-${{ kmup.ref_name }}-${{ vars.myvar }}-${{ kmup.event.pusher.username }}
jobs:
  wf2-job:
    runs-on: ubuntu-latest
    steps:
...
`
		wf3TreePath := ".kmup/workflows/concurrent-workflow-3.yml"
		wf3FileContent := `name: concurrent-workflow-3
on: 
  push:
    paths:
      - '.kmup/workflows/concurrent-workflow-3.yml'
concurrency:
  group: workflow-main-abc${{ 123 }}-${{ kmup.event.pusher.username }}
jobs:
  wf3-job:
    runs-on: ubuntu-latest
    steps:
...
on: 
  push:
    paths:
      - '.kmup/workflows/concurrent-workflow-2.yml'
concurrency: workflow-${{ kmup.ref_name }}-${{ vars.myvar }}-${{ kmup.event.pusher.username }}
jobs:
  wf2-job:
    runs-on: ubuntu-latest
    steps:
...
on: 
  push:
    paths:
      - '.kmup/workflows/concurrent-workflow-3.yml'
concurrency: workflow-main-abc${{ 123 }}-${{ kmup.event.pusher.username }}
jobs:
  wf3-job:
    runs-on: ubuntu-latest
    steps:
...
func TestPullRequestWorkflowConcurrency(t *testing.T) {
	onKmupRun(t, func(t *testing.T, u *url.URL) {
		...
		// init the workflow
		wfTreePath := ".kmup/workflows/pull.yml"
		wfFileContent := `name: Pull Request
on: pull_request
concurrency:
  group: pull-request-test
  cancel-in-progress: ${{ !startsWith(kmup.head_ref, 'do-not-cancel/') }}
jobs:
  wf1-job:
    runs-on: ubuntu-latest
    steps:
...
func TestWorkflowDispatchConcurrency(t *testing.T) {
	onKmupRun(t, func(t *testing.T, u *url.URL) {
		...
		wf1TreePath := ".kmup/workflows/workflow-dispatch-concurrency.yml"
...
func TestScheduleConcurrency(t *testing.T) {
	onKmupRun(t, func(t *testing.T, u *url.URL) {
		...
		wf1TreePath := ".kmup/workflows/schedule-concurrency.yml"
...
concurrency:
  ...
  cancel-in-progress: ${{ kmup.event_name == 'push' }}
jobs:
  job:
    runs-on: ubuntu-latest
    steps:
...
`
		...
		wf4TreePath := ".kmup/workflows/concurrent-workflow-4.yml"
		wf4FileContent := `name: concurrent-workflow-4
on: 
  push:
    paths:
      - '.kmup/workflows/concurrent-workflow-4.yml'
concurrency:
  group: workflow-group-2
jobs:
  wf4-job1:
...
func TestCancelConcurrentRun(t *testing.T) {
	onKmupRun(t, func(t *testing.T, u *url.URL) {
		...
		// init the workflow
		wfTreePath := ".kmup/workflows/run.yml"
...
func TestAbandonConcurrentRun(t *testing.T) {
	onKmupRun(t, func(t *testing.T, u *url.URL) {
		...
		wf1TreePath := ".kmup/workflows/workflow-1.yml"
		wf1FileContent := `name: Workflow-1
on: 
  push:
    paths:
      - '.kmup/workflows/workflow-1.yml'
concurrency:
  group: test-group
jobs:
  wf1-job1:
...
`
		...
		wf2TreePath := ".kmup/workflows/workflow-2.yml"
		wf2FileContent := `name: Workflow-2
on: 
  push:
    paths:
      - '.kmup/workflows/workflow-2.yml'
concurrency:
  group: test-group
jobs:
  wf2-job1:
