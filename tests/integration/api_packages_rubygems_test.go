...
func TestPackageRubyGems(t *testing.T) {
	...
	testAnotherGemName := "kmup-another"
...
`, testGemContentChecksum)
	...
	t.Run("Versions", func(t *testing.T) {
		...
		resp := MakeRequest(t, req, http.StatusOK)
		assert.Equal(t, `---
kmup 1.0.5 08843c2dd0ea19910e6b056b98e38f1c
kmup-another 0.99 8b639e4048d282941485368ec42609be
`, resp.Body.String())
	})
