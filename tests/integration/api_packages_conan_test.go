...
import (
	...
	conan_model "github.com/kumose/kmup/models/packages/conan"
	"github.com/kumose/kmup/models/unittest"
	user_model "github.com/kumose/kmup/models/user"
	conan_module "github.com/kumose/kmup/modules/packages/conan"
	"github.com/kumose/kmup/modules/setting"
	conan_router "github.com/kumose/kmup/routers/api/packages/conan"
	package_service "github.com/kumose/kmup/services/packages"
...
const (
	...
	conanLicense     = "MIT"
	conanAuthor      = "Kmup <info@kmup.io>"
	conanHomepage    = "https://kmup.io/"
	conanURL         = "https://kmup.com/"
		...
		t.Run("Search", func(t *testing.T) {
			...
			t.Run("Recipe", func(t *testing.T) {
				...
				cases := []struct {
					...
					{"ConanPackage", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.3@dummy/test", "ConanPackage/1.2@dummy/final", "ConanPackage/1.2@kmup/test", "ConanPackage/1.2@kmup/final"}},
					{"ConanPackage/1.2", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.2@dummy/final", "ConanPackage/1.2@kmup/test", "ConanPackage/1.2@kmup/final"}},
					{"ConanPackage/1.1", []string{}},
					{"Conan*", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.3@dummy/test", "ConanPackage/1.2@dummy/final", "ConanPackage/1.2@kmup/test", "ConanPackage/1.2@kmup/final"}},
					{"ConanPackage/", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.3@dummy/test", "ConanPackage/1.2@dummy/final", "ConanPackage/1.2@kmup/test", "ConanPackage/1.2@kmup/final"}},
					{"ConanPackage/*", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.3@dummy/test", "ConanPackage/1.2@dummy/final", "ConanPackage/1.2@kmup/test", "ConanPackage/1.2@kmup/final"}},
					{"ConanPackage/1*", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.3@dummy/test", "ConanPackage/1.2@dummy/final", "ConanPackage/1.2@kmup/test", "ConanPackage/1.2@kmup/final"}},
					{"ConanPackage/*2", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.2@dummy/final", "ConanPackage/1.2@kmup/test", "ConanPackage/1.2@kmup/final"}},
					{"ConanPackage/1*2", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.2@dummy/final", "ConanPackage/1.2@kmup/test", "ConanPackage/1.2@kmup/final"}},
					{"ConanPackage/1.2@", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.2@dummy/final", "ConanPackage/1.2@kmup/test", "ConanPackage/1.2@kmup/final"}},
					...
					{"ConanPackage/1.2@kmup/*", []string{"ConanPackage/1.2@kmup/test", "ConanPackage/1.2@kmup/final"}},
					{"*/*@dummy", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.3@dummy/test", "ConanPackage/1.2@dummy/final"}},
					{"*/*@*/final", []string{"ConanPackage/1.2@dummy/final", "ConanPackage/1.2@kmup/final"}},
				}
		...
		t.Run("Search", func(t *testing.T) {
			t.Run("Recipe", func(t *testing.T) {
				...
				cases := []struct {
					...
					{"ConanPackage", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.3@dummy/test", "ConanPackage/1.2@kmup/test", "ConanPackage/1.2@kmup/final"}},
					{"ConanPackage/1.2", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.2@kmup/test", "ConanPackage/1.2@kmup/final"}},
					{"ConanPackage/1.1", []string{}},
					{"Conan*", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.3@dummy/test", "ConanPackage/1.2@kmup/test", "ConanPackage/1.2@kmup/final"}},
					{"ConanPackage/", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.3@dummy/test", "ConanPackage/1.2@kmup/test", "ConanPackage/1.2@kmup/final"}},
					{"ConanPackage/*", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.3@dummy/test", "ConanPackage/1.2@kmup/test", "ConanPackage/1.2@kmup/final"}},
					{"ConanPackage/1*", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.3@dummy/test", "ConanPackage/1.2@kmup/test", "ConanPackage/1.2@kmup/final"}},
					{"ConanPackage/*2", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.2@kmup/test", "ConanPackage/1.2@kmup/final"}},
					{"ConanPackage/1*2", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.2@kmup/test", "ConanPackage/1.2@kmup/final"}},
					{"ConanPackage/1.2@", []string{"ConanPackage/1.2@dummy/test", "ConanPackage/1.2@kmup/test", "ConanPackage/1.2@kmup/final"}},
					...
					{"*/*@*/final", []string{"ConanPackage/1.2@kmup/final"}},
				}
