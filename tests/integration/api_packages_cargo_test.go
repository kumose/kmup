...
import (
	...
	cargo_module "github.com/kumose/kmup/modules/packages/cargo"
	"github.com/kumose/kmup/modules/setting"
	cargo_router "github.com/kumose/kmup/routers/api/packages/cargo"
	cargo_service "github.com/kumose/kmup/services/packages/cargo"
   ...
   "deps":[
      {
         "name":"dep",
         "version_req":"1.0",
         "registry": "https://kmup.io/user/_cargo-index",
         "kind": "normal",
			...
			t.Run("Index", func(t *testing.T) {
				t.Run("Git", func(t *testing.T) {
					t.Run("Entry", func(t *testing.T) {
						...
						assert.Equal(t, "https://kmup.io/user/_cargo-index", *dep.Registry)
