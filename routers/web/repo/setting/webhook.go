...
func Webhooks(ctx *context.Context) {
	...
	ctx.Data["Description"] = ctx.Tr("repo.settings.hooks_desc", "https://docs.kmup.com/usage/webhooks")
...
// KmupHooksNewPost response for creating Kmup webhook
func KmupHooksNewPost(ctx *context.Context) {
	createWebhook(ctx, kmupHookParams(ctx))
}

// KmupHooksEditPost response for editing Kmup webhook
func KmupHooksEditPost(ctx *context.Context) {
	editWebhook(ctx, kmupHookParams(ctx))
}

func kmupHookParams(ctx *context.Context) webhookParams {
