...
import (
	...
	issue_template "github.com/kumose/kmup/modules/issue/template"
...
var pullRequestTemplateCandidates = []string{
	...
	"pull_request_template.yaml",
	"pull_request_template.yml",
	".kmup/PULL_REQUEST_TEMPLATE.md",
	".kmup/PULL_REQUEST_TEMPLATE.yaml",
	".kmup/PULL_REQUEST_TEMPLATE.yml",
	".kmup/pull_request_template.md",
	".kmup/pull_request_template.yaml",
	".kmup/pull_request_template.yml",
