...
import (
	...
	"github.com/kumose/kmup/routers/api/packages/alpine"
	"github.com/kumose/kmup/routers/api/packages/arch"
	"github.com/kumose/kmup/routers/api/packages/cargo"
	"github.com/kumose/kmup/routers/api/packages/chef"
	"github.com/kumose/kmup/routers/api/packages/composer"
	"github.com/kumose/kmup/routers/api/packages/conan"
	"github.com/kumose/kmup/routers/api/packages/conda"
	"github.com/kumose/kmup/routers/api/packages/container"
	"github.com/kumose/kmup/routers/api/packages/cran"
	"github.com/kumose/kmup/routers/api/packages/debian"
	"github.com/kumose/kmup/routers/api/packages/generic"
	"github.com/kumose/kmup/routers/api/packages/goproxy"
	"github.com/kumose/kmup/routers/api/packages/helm"
	"github.com/kumose/kmup/routers/api/packages/maven"
	"github.com/kumose/kmup/routers/api/packages/npm"
	"github.com/kumose/kmup/routers/api/packages/nuget"
	"github.com/kumose/kmup/routers/api/packages/pub"
	"github.com/kumose/kmup/routers/api/packages/pypi"
	"github.com/kumose/kmup/routers/api/packages/rpm"
	"github.com/kumose/kmup/routers/api/packages/rubygems"
	"github.com/kumose/kmup/routers/api/packages/swift"
	"github.com/kumose/kmup/routers/api/packages/vagrant"
	...
	return func(ctx *context.Context) {
		if ctx.Data["IsApiToken"] == true {
			...
			if ok { // it's a personal access token but not oauth2 token
				...
				if !scopeMatched {
					ctx.Resp.Header().Set("WWW-Authenticate", `Basic realm="Kmup Package API"`)
