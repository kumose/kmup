...
Create new directory `.vscode` in Kmup root folder and copy contents of folder [contrib/ide/vscode](vscode/) to it. You can now use `Ctrl`+`Shift`+`B` to build kmup executable and `F5` to run it in debug mode.
