...
const cssVarFiles = [
  ...
  fileURLToPath(new URL('web_src/css/themes/theme-kmup-light.css', import.meta.url)),
  fileURLToPath(new URL('web_src/css/themes/theme-kmup-dark.css', import.meta.url)),
];
