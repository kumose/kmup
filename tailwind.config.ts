...
const vars = extractRootVars([
  readFileSync(new URL('web_src/css/themes/theme-kmup-light.css', import.meta.url), 'utf8'),
  readFileSync(new URL('web_src/css/themes/theme-kmup-dark.css', import.meta.url), 'utf8'),
].join('\n'));
