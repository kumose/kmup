...
`, rendered)
	...
	t.Run("AbsoluteAndRelative", func(t *testing.T) {
		rctx := NewRenderContextRepoFile(t.Context(), repo1, RepoFileOptions{CurrentRefPath: "branch/master"}).
...
`)
		assert.NoError(t, err)
		assert.Equal(t,
			`<p><a href="/user2/repo1/src/branch/master/test" rel="nofollow">/test</a>
<a href="/user2/repo1/src/branch/master/test" rel="nofollow">./test</a>
<a href="/user2/repo1/src/branch/master/image" target="_blank" rel="nofollow noopener"><img src="/user2/repo1/media/branch/master/image" alt="/image"/></a>
<a href="/user2/repo1/src/branch/master/image" target="_blank" rel="nofollow noopener"><img src="/user2/repo1/media/branch/master/image" alt="./image"/></a></p>
`, rendered)
	})
