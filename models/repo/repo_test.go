...
func TestRepoAPIURL(t *testing.T) {
	...
	assert.Equal(t, "https://try.kmup.io/api/v1/repos/user12/repo10", repo.APIURL())
}
...
func TestGetRepositoryByURL(t *testing.T) {
	...
	t.Run("ValidHttpURL", func(t *testing.T) {
		testRepo2(t, "https://try.kmup.io/user2/repo2")
		testRepo2(t, "https://try.kmup.io/user2/repo2.git")
	})

	t.Run("ValidGitSshURL", func(t *testing.T) {
		testRepo2(t, "git+ssh://sshuser@try.kmup.io/user2/repo2")
		testRepo2(t, "git+ssh://sshuser@try.kmup.io/user2/repo2.git")

		testRepo2(t, "git+ssh://try.kmup.io/user2/repo2")
		testRepo2(t, "git+ssh://try.kmup.io/user2/repo2.git")
	})

	t.Run("ValidImplicitSshURL", func(t *testing.T) {
		testRepo2(t, "sshuser@try.kmup.io:user2/repo2")
		testRepo2(t, "sshuser@try.kmup.io:user2/repo2.git")
		...
		testRelax(t, "try.kmup.io:user2/repo2")
		testRelax(t, "try.kmup.io:user2/repo2.git")
	})
}
