...
import (
	...
	"github.com/kumose/kmup/models/migrations/v1_10"
	"github.com/kumose/kmup/models/migrations/v1_11"
	"github.com/kumose/kmup/models/migrations/v1_12"
	"github.com/kumose/kmup/models/migrations/v1_13"
	"github.com/kumose/kmup/models/migrations/v1_14"
	"github.com/kumose/kmup/models/migrations/v1_15"
	"github.com/kumose/kmup/models/migrations/v1_16"
	"github.com/kumose/kmup/models/migrations/v1_17"
	"github.com/kumose/kmup/models/migrations/v1_18"
	"github.com/kumose/kmup/models/migrations/v1_19"
	"github.com/kumose/kmup/models/migrations/v1_20"
	"github.com/kumose/kmup/models/migrations/v1_21"
	"github.com/kumose/kmup/models/migrations/v1_22"
	"github.com/kumose/kmup/models/migrations/v1_23"
	"github.com/kumose/kmup/models/migrations/v1_24"
	"github.com/kumose/kmup/models/migrations/v1_25"
	"github.com/kumose/kmup/models/migrations/v1_26"
	"github.com/kumose/kmup/models/migrations/v1_6"
	"github.com/kumose/kmup/models/migrations/v1_7"
	"github.com/kumose/kmup/models/migrations/v1_8"
	"github.com/kumose/kmup/models/migrations/v1_9"
...
const minDBVersion = 70 // Kmup 1.5.3
...
func prepareMigrationTasks() []*migration {
	...
	preparedMigrations = []*migration{
		// Kmup 1.5.0 ends at database version 69
		...
		// Kmup 1.6.0 ends at database version 73
		...
		// Kmup 1.7.0 ends at database version 76
		...
		// Kmup 1.8.0 ends at database version 82
		...
		// Kmup 1.9.0 ends at database version 88
		...
		// Kmup 1.10.0 ends at database version 102
		...
		// Kmup 1.11.0 ends at database version 117
		...
		// Kmup 1.12.0 ends at database version 140
		...
		// Kmup 1.13.0 ends at database version 155
		...
		// Kmup 1.14.0 ends at database version 178
		...
		// Kmup 1.15.0 ends at database version 189
		...
		// Kmup 1.16.2 ends at database version 211
		...
		// Kmup 1.17.0 ends at database version 224
		...
		// Kmup 1.18.0 ends at database version 231
		...
		// Kmup 1.19.0 ends at database version 244
		...
		// Kmup 1.20.0 ends at database version 260
		...
		// Kmup 1.21.0 ends at database version 280
		...
		// Kmup 1.22.0-rc0 ends at database version 294
		...
		// Kmup 1.22.0-rc1 ends at migration ID number 298 (database version 299)
		...
		// Kmup 1.23.0-rc0 ends at migration ID number 311 (database version 312)
		...
		// Kmup 1.24.0 ends at migration ID number 320 (database version 321)

		newMigration(321, "Use LONGTEXT for some columns and fix review_state.updated_files column", v1_25.UseLongTextInSomeColumnsAndFixBugs),
		newMigration(322, "Extend comment tree_path length limit", v1_25.ExtendCommentTreePathLength),
		// Kmup 1.25.0 ends at migration ID number 322 (database version 323)
...
func EnsureUpToDate(ctx context.Context, x *xorm.Engine) error {
	...
	if minDBVersion > currentDB {
		return fmt.Errorf("DB version %d (<= %d) is too old for auto-migration. Upgrade to Kmup 1.6.4 first then upgrade to this version", currentDB, minDBVersion)
	}

	expectedDB := ExpectedDBVersion()

	if currentDB != expectedDB {
		return fmt.Errorf(`current database version %d is not equal to the expected version %d. Please run "kmup [--config /path/to/app.ini] migrate" to update the database version`, currentDB, expectedDB)
	}
...
func Migrate(ctx context.Context, x *xorm.Engine) error {
	...
	// Set a new clean the default mapper to GonicMapper as that is the default for Kmup.
	...
	// Outdated Kmup database version is not supported
	if curDBVer < minDBVersion {
		log.Fatal(`Kmup no longer supports auto-migration from your previously installed version.
Please try upgrading to a lower version first (suggested v1.6.4), then upgrade to this version.`)
		return nil
	}

	// Downgrading Kmup's database version not supported
	if maxDBVer < curDBVer {
		msg := fmt.Sprintf("Your database (migration version: %d) is for a newer Kmup, you can not use the newer database for this old Kmup release (%d).", curDBVer, maxDBVer)
		msg += "\nKmup will exit to keep your database safe and unchanged. Please use the correct Kmup release, do not change the migration version manually (incorrect manual operation may lose data)."
		if !setting.IsProd {
