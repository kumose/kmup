...
// some functions like RegeneratePublicKeys needs this tag to skip the keys generated by Kmup, while keep other keys
const AuthorizedStringCommentPrefix = `# kmup public key`
