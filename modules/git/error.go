...
func (err *ErrPushRejected) GenerateMessage() {
	...
	// > To /work/kmup/tests/integration/kmup-integration-sqlite/kmup-repositories/user2/repo1.git
	// >  ! [remote rejected] 44e67c77559211d21b630b902cdcc6ab9d4a4f51 -> develop (pre-receive hook declined)
	// > error: failed to push some refs to '/work/kmup/tests/integration/kmup-integration-sqlite/kmup-repositories/user2/repo1.git'
	//
