...
7ae1K28QbMMcqI8CqwIrgwg9nTOp8Oj9q81plUY7ZuwXN8Vvs8wbAAA=`
	...
	assert.Equal(t, "kmup-test", p.Name)
	...
	assert.Equal(t, "https://kmup.io", p.VersionMetadata.ProjectURL)
	...
	assert.Equal(t, "kmup-test-1.0.2-1.src.rpm", p.FileMetadata.SourceRpm)
