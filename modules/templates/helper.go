// Copyright 2018 The Kmup Authors. All rights reserved.
...
import (
	...
	"github.com/kumose/kmup/modules/templates/eval"
...
func NewFuncMap() template.FuncMap {
	return map[string]any{
		...
		"AppUrl": func() string {
			...
			// And it's difficult for Kmup to guess absolute URL correctly with zero configuration,
			// because Kmup doesn't know whether the scheme is HTTP or HTTPS unless the reverse proxy could tell Kmup.
