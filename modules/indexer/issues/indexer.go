...
import (
	...
	db_model "github.com/kumose/kmup/models/db"
	repo_model "github.com/kumose/kmup/models/repo"
	"github.com/kumose/kmup/modules/graceful"
	"github.com/kumose/kmup/modules/indexer"
	"github.com/kumose/kmup/modules/indexer/issues/bleve"
	"github.com/kumose/kmup/modules/indexer/issues/db"
	"github.com/kumose/kmup/modules/indexer/issues/elasticsearch"
	"github.com/kumose/kmup/modules/indexer/issues/internal"
	"github.com/kumose/kmup/modules/indexer/issues/meilisearch"
		...
		case "bleve":
			defer func() {
				if err := recover(); err != nil {
					...
					log.Error("You can completely remove the %q directory to make Kmup recreate the indexes", setting.Indexer.IssuePath)
					globalIndexer.Store(dummyIndexer)
