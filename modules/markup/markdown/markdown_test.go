...
func TestRender_Images(t *testing.T) {
	...
	render(
		...
		`<p dir="auto"><img src="http://localhost:3326/user13/repo11/a.jpg" loading="lazy"/></p>`)
}
...
<p>Ideas and codes</p>
<ul>
<li>Bezier widget (by <a href="/r-lyeh" rel="nofollow">@r-lyeh</a>) <a href="http://localhost:3326/ocornut/imgui/issues/786" class="ref-issue" rel="nofollow">ocornut/imgui#786</a></li>
...
func TestRenderEmojiInLinks_Issue12331(t *testing.T) {
	testcase := `[Link with emoji :moon: in text](https://kmup.io)`
	expected := `<p><a href="https://kmup.io" rel="nofollow">Link with emoji <span class="emoji" aria-label="waxing gibbous moon">🌔</span> in text</a></p>
`
	res, err := markdown.RenderString(markup.NewTestRenderContext(), testcase)
	assert.NoError(t, err)
