...
func TestPushCommits_ToAPIPayloadCommits(t *testing.T) {
	...
	assert.Equal(t, "https://try.kmup.io/user2/repo16/commit/69554a6", payloadCommits[0].URL)
	...
	assert.Equal(t, "https://try.kmup.io/user2/repo16/commit/27566bd", payloadCommits[1].URL)
	...
	assert.Equal(t, "https://try.kmup.io/user2/repo16/commit/5099b81", payloadCommits[2].URL)
	...
	assert.Equal(t, "https://try.kmup.io/user2/repo16/commit/69554a6", headCommit.URL)
