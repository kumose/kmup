...
var (
	...
	// AppSubURL represents the sub-url mounting point for kmup, parsed from "ROOT_URL"
	// It is either "" or starts with '/' and ends without '/', such as '/{sub-path}'.
	// This value is empty if site does not have sub-url.
	AppSubURL string

	// UseSubURLPath makes Kmup handle requests with sub-path like "/sub-path/owner/repo/...",
	...
	// LocalURL is the url for locally running applications to contact Kmup. It always has a '/' suffix
...
func loadServerFrom(rootCfg ConfigProvider) {
	...
	AppName = rootCfg.Section("").Key("APP_NAME").MustString("Kumo: Working with a cup of tea")
