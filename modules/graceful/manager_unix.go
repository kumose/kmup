...
import (
	...
	"github.com/kumose/kmup/modules/graceful/releasereopen"
...
func (g *Manager) start() {
	...
	g.notify(statusMsg("Starting Kmup"))
	g.notify(pidMsg())
...
func (g *Manager) DoGracefulRestart() {
	if setting.GracefulRestartable {
		...
		// doFork calls RestartProcess which starts a new Kmup process, so this parent process needs to exit
