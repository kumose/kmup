...
// StartInContext starts a trace span in Kmup's mutable context (usually the web request context).
// Due to the design limitation of Kmup's web framework, it can't use `context.WithValue` to bind a new span into a new context.
