...
require (
	...
	github.com/kumose-go/chi v0.3.8
	github.com/kumose-go/dingtalk v0.1.0
	github.com/kumose-go/kmup v0.5.6
	github.com/kumose-go/levelqueue v0.5.2
	github.com/kumose/actions-proto-go v0.4.1
...
require (
	...
	github.com/kumose/km-vet v0.2.3 // indirect
...
replace git.sr.ht/~mariusor/go-xsd-duration => github.com/kumose-go/go-xsd-duration v0.2.0
